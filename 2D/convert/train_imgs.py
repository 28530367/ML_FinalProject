...
output_dir = "/media/disk2/HSW/MachineLearning/Final_project/2D/train/imgs"  # 保存圖片的資料夾名稱
record_file = "/media/disk2/HSW/MachineLearning/Final_project/2D/convert/train_imgs-processed.txt" # 記錄處理過檔案的路徑
